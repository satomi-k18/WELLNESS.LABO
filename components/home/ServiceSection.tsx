    ...
    return (
        <section className="bg-white py-20 md:py-32">
            <div className="mx-auto max-w-4xl px-6 md:px-10">
                ...
                {/* Yoga Class Schedule */}
                <div className="mb-16">
                    <h3 className="mb-8 text-xl font-bold text-slate-800">ヨガクラス</h3>
                    <div className="grid gap-4 sm:grid-cols-2">
                        {yogaSchedule.map((day) => (
                            <div
                                key={day.day}
                                className="rounded-2xl border border-pink-50 bg-slate-50 p-6"
                            >
                                <p className="mb-1 text-lg font-bold text-pink-400">{day.day}</p>
                                <p className="mb-4 text-xs text-slate-400">{day.venue}</p>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="rounded-2xl bg-pink-50 p-8">
                        <h3 className="mb-3 text-lg font-bold text-slate-800">出張ヨガ</h3>
                        <p className="mb-5 text-sm leading-relaxed text-slate-600">
                            ガチガチになった身体と心を、<br />
                            呼吸とやさしい動きでゆるめる時間。
                        </p>
                        <ul className="mb-5 space-y-1 text-sm text-slate-500">
                    ...
                    <div className="rounded-2xl bg-emerald-50 p-8">
                        <h3 className="mb-3 text-lg font-bold text-slate-800">アロマ時間</h3>
                        <p className="mb-5 text-sm leading-relaxed text-slate-600">
                            香りでほっとひと息。<br />
                            お好きなクラフトを作れます。
                        </p>
